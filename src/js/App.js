                    ...
                    <div className="container app-container">
                        <div className="row main">
                            <div className="col-lg-6 screenshots">
                                <img className="android" src={process.env.PUBLIC_URL + '/android.png'} width='270'
                                     height='500' alt='Screenshot Android'/>
                                <img className="iOS" src={process.env.PUBLIC_URL + '/iOS.png'} width='270' height='500'
                                     alt='Screenshot iOS'/>
                            </div>
                            ...
                            <div className="col-lg-6 auth">
                                <div className="auth-content">
                                    ...
                                    <h6 className="main-description text-muted">Sign up to see photos and
                                        videos<br/> from your friends</h6>
                                    <FacebookLogin
                                        ...
                                        render={renderProps => (
                                            <div className='facebook-button-div'>
                                                <button className="facebook-button" onClick={renderProps.onClick}>
                                                    <span className="facebook-icon-div"><i
